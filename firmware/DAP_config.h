...
static __inline void PORT_JTAG2_SETUP(void)
{
#if 0
#if (DAP_JTAG != 0)
    // TCK output
    pin_out_init(JTAG2_TCK_PIN_PORT, JTAG2_TCK_PIN_Bit);
    JTAG2_TCK_PIN_PORT->BSRR = JTAG2_TCK_PIN;
    
    // TMS output
    pin_out_init(JTAG2_TMS_PIN_PORT, JTAG2_TMS_PIN_Bit);
    JTAG2_TMS_PIN_PORT->BSRR = JTAG2_TMS_PIN;

	  // TDI output
    pin_out_init(JTAG2_TDI_PIN_PORT, JTAG2_TDI_PIN_Bit);
    JTAG2_TDI_PIN_PORT->BSRR = JTAG2_TDI_PIN;

		// TDO input
    pin_in_init(JTAG2_TDO_PIN_PORT, JTAG2_TDO_PIN_Bit, 1);
